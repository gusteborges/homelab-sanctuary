...
MIDDLEWARE = [
    ...
    'django.middleware.csrf.CsrfViewMiddleware',  # O CORS deve vir antes deste!
...
PASSWORD_HASHERS = [
    'django.contrib.auth.hashers.BCryptSHA256PasswordHasher', # Define o Bcrypt como principal
